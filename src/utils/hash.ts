/**
 * SHA-256 implementado en JS puro — sin dependencias nativas.
...
export function sha256(message: string): string {
  ...
  for (let i = 0; i < message.length; i++) {
    ...
    if (code < 0x80) {
      ...
      msgBytes.push((code >> 6) | 0xc0, (code & 0x3f) | 0x80);
    } else {
      msgBytes.push((code >> 12) | 0xe0, ((code >> 6) & 0x3f) | 0x80, (code & 0x3f) | 0x80);
    }
  }
